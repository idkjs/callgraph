...
cd ..
./function_callgraph.native callees f11 "void fct11()" dir1/file1
dot -Tpng f11.fct.callees.gen.dot > f11.fct.callees.gen.dot.png

# Test the generation of caller's tree
./function_callgraph.native callers f22 "void fct22()" dir1/file2
dot -Tpng f22.fct.callers.gen.dot > f22.fct.callers.gen.dot.png

./function_callgraph.native c2c f12 "void fct12()" dir1/file1 f22 "void fct22()" dir1/file2

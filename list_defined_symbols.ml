...
let command =
  Core.Std.Command.basic
    ~summary:"This program generates a json file listing all the symbols defined in each json directory generated by the callers's analysis"
	...
	try
	  ...
	  | Some json ->
	    ...
	    Printf.printf "--------------------------------------------------------------------------------\n";
	    list_defined_symbols content rootdir_fullpath defined_symbols_jsonfile
